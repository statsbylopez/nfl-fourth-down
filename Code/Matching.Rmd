...
matched.subset.atc.love$cond.catDOME <- 1 - (matched.subset.atc.love$cond.catDRY + matched.subset.atc.love$cond.catPrecipitation)
...
love.plot$variable[love.plot$variable == "cond.catDome"] <- "condcatDry"
